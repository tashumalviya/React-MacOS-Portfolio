    ...
    return (
        <footer className='dock' >
            ...
            <div
                ...
                className="icon pdf"><img src="/doc-icons/pdf (1).svg" alt="" /></div>
            <div
            ...
            <div
                ...
                className="icon spotify"><img src="/doc-icons/spotify (1).svg" alt="" /></div>
            <div
            onClick={()=>{window.open("mailto:malviyatashu@gmail.com","_blank")}}
             className="icon mail"><img src="/doc-icons/mail.svg" alt="" /></div>
            <div 
            onClick={()=>{window.open("https://www.linkedin.com/in/tashu-malviya/","_blank")}}
            
            className="icon link"><img src="/doc-icons/link (1).svg" alt="" /></div>
            <div
